...
class CNN:
    def __init__(self, my_shelve, segment_size=128, n_filters=196,
                 ...
                 dropout_rate=0.05, eval_iter=10, filters_size=16, n_classes=6,n_hidden=1024):
    ...
    def Training(self,filetrainingChekpoint):
        ...
        for i in range(self.epochs):
            ...
            sess.run(train_step, feed_dict={
                     x: xt, y_: yt, keep_prob: self.dropout_rate})
    ...
    def Testing(self,filetrainingChekpoint):
        ...
        with tf.Session() as sess:
            ...
            saver.restore(sess, tf.train.latest_checkpoint(filetrainingChekpoint))
            ...
            test_accuracy = sess.run(accuracy, feed_dict={
                inputs_: data_test, labels_: labels_test, keep_prob_: 1})
